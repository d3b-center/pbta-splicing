...
&& R -e "install.packages(c('BiocManager','pheatmap','optparse','hrbrthemes','viridis','plyr','ggstatsplot','diptest'), dependencies=TRUE, repos='http://cran.us.r-project.org')" \
&& R -e 'BiocManager::install(c("maftools", "ConsensusClusterPlus", "sva", "EnhancedVolcano", "DESeq2", "fgsea", "GSVA"))' \
...
COPY -r analyses/splicing_events_functional_sites/extract_recurrent_splicing_events_hgg.pl .
