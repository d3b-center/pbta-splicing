...
#cat ../../data/rMATS_merged.comparison.tsv.gz | zcat | grep ^SE | grep SRSF11 | grep "70231858\t70231975" | grep "70228421\t70228555" | grep "70232267\t70232375" | awk '{print "control-BS"\t"$34"\tinclusion"}' | sort -u |tail -1 > input/se.srsf11.ctrl.incl.txt
#cat ../../data/rMATS_merged.comparison.tsv.gz | zcat | grep ^SE | grep SRSF11 | grep "70231858\t70231975" | grep "70228421\t70228555" | grep "70232267\t70232375" | awk '{print "control-BS\t"1-$34"\tskip"}' | sort -u | tail -1 >> input/se.srsf11.ctrl.incl.txt
