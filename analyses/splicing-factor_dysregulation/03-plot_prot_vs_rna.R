...
# Save plot as TIFF
file_corr_prot_plot <- file.path(analysis_dir, "plots", "corr_SF_prot_rna.tiff")
corr_plots <- arrangeGrob(plot_RBM15,plot_SAMD4A,plot_MSI1, plot_NOVA2, ncol=1) #generates g
ggsave(file=file_corr_prot_plot, corr_plots, dpi=300, width =10,
       height = 40, units = "in") #saves corr_phos_plot
