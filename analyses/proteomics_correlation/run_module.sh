...
## create table with PSIs
perl 02-add_psi_to_table.pl

## convert table to bed for peptide sequence extraction
...
perl 03-convert_to_peptide.pl results/mixed_events.fasta
