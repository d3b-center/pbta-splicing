...
MakePsiPhosScatterPlots <- function(select_gene, select_site, HISTdata, SPLICEdata, SPLICE_KFid, PHOSdata, PHOS_KFid){
  ...
  #data frame to store psi and corresonding phos abundance values for each HOPE sample
...
#draw scatter plot of psi values and phospho abundances for selected gene and phospho site
select_gene<-"CLK1"
...
MakePsiPhosScatterPlots(select_gene, select_site, HISTdata, SPLICEdata, SPLICE_KFid, PHOSdata, PHOS_KFid)
