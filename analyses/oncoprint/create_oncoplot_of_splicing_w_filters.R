...
somaticInteractions(maf = maf_total , genes=gene_list_brain$V1, countType = "all", fontSize = .6, showCounts = FALSE)
co_occur_tab = somaticInteractions(maf = maf_total , countType = "all", fontSize = .5, showCounts = FALSE)