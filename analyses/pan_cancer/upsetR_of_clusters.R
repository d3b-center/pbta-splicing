...
cc_expr_1 = read.table("/Users/naqvia/Desktop/AS-DMG/analyses/pan_cancer/CC_memberships_expr.Cl1.v3.txt", sep = "\t")
cc_expr_2 = read.table("/Users/naqvia/Desktop/AS-DMG/analyses/pan_cancer/CC_memberships_expr.Cl2.v3.txt", sep = "\t")
cc_expr_3 = read.table("/Users/naqvia/Desktop/AS-DMG/analyses/pan_cancer/CC_memberships_expr.Cl3.v3.txt", sep = "\t")
cc_expr_4 = read.table("/Users/naqvia/Desktop/AS-DMG/analyses/pan_cancer/CC_memberships_expr.Cl4.v3.txt", sep = "\t")
cc_expr_5 = read.table("/Users/naqvia/Desktop/AS-DMG/analyses/pan_cancer/CC_memberships_expr.Cl3.v3.txt", sep = "\t")
cc_expr_6 = read.table("/Users/naqvia/Desktop/AS-DMG/analyses/pan_cancer/CC_memberships_expr.Cl4.v3.txt", sep = "\t")
...
k = upset(fromList(listInput), 
          mainbar.y.label = "Cluster Intersections", sets.x.label = "Clusters", order.by = "freq", nsets = 12,   
          queries = list(list(query = intersects, params = list("psi_4"), color = "red", active = T), 
                         ...
                         list(query = intersects, params = list("psi_6","expr_2"), color = "red", active = T),
                         list(query = intersects, params = list("psi_6","expr_1"), color = "red", active = T),
                         ...
                         list(query = intersects, params = list("psi_4","expr_3", "expr_5"), color = "red", active = T),
                         list(query = intersects, params = list("psi_4","expr_4", "expr_6"), color = "red", active = T),
                         list(query = intersects, params = list("psi_5","expr_1"), color = "red", active = T)
                         ))
