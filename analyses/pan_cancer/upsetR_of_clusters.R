...
k = upset(fromList(listInput), 
          mainbar.y.label = "Cluster Intersections", sets.x.label = "Clusters", order.by = "freq",
          mb.ratio = c(0.5,0.50), text.scale = c(1.3, 1.3, 1.3, 1.3, 2, 1.4),point.size = 1.5, line.size = 1.5, nsets = 10,
          queries = list(list(query = intersects, 
                              params = list("psi_4"), color = "red", active = T), list(query = intersects,  
                              params = list("psi_5"), color = "red", active = T), list(query = intersects, 
                              ...
                              params = list("psi_6"), color = "red", active = T)))
...
upset(fromList(listInput), 
      mainbar.y.label = "Cluster Intersections", sets.x.label = "Clusters", order.by = "freq",
      mb.ratio = c(0.5,0.50), text.scale = c(1.3, 1.3, 1.3, 1.3, 2, 1.4),point.size = 1.5, line.size = 1.5, nsets = 7)
...
list_1 = read.table("/Users/naqvia/Desktop/AS-DMG/analyses/pan_cancer/perc_hist_as.ATRT.thr20.tsv", sep = "\t")
list_2 = read.table("/Users/naqvia/Desktop/AS-DMG/analyses/pan_cancer/perc_hist_as.Cran.thr20.tsv", sep = "\t")
list_3 = read.table("/Users/naqvia/Desktop/AS-DMG/analyses/pan_cancer/perc_hist_as.Epend.thr20.tsv", sep = "\t")
list_4 = read.table("/Users/naqvia/Desktop/AS-DMG/analyses/pan_cancer/perc_hist_as.HGAT.thr20.tsv", sep = "\t")
...
upset(fromList(listInput), 
      mainbar.y.label = "Aberrant Splicing Overlap", sets.x.label = "Clusters", order.by = "freq",
      mb.ratio = c(0.5,0.50), text.scale = c(1.3, 1.3, 1.3, 1.3, 2, 1.4),point.size = 2, line.size = 1.5, nsets = 6)
