...
my ($histology,$primary_tumor_dat,$primary_tumor_plus_dat) = ($ARGV[0], $ARGV[1],$ARGV[2]);


## merged rMATS file generated by previous script/hardcoded
my $rmats_tsv = "../../data/v5/rMATS_merged.comparison.tsv.gz";
