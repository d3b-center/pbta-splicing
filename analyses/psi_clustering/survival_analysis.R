...
# set up directories
setwd("/Users/naqvia/Desktop/AS-DMG/analyses/psi_clustering/results")
input_dir <- "/Users/naqvia/Desktop/AS-DMG/analyses/psi_clustering" # you can set this to the directory which contains this code


data_dir  <- file.path("/Users/naqvia/Desktop/AS-DMG/input") # contains pbta-histologies file and all input .dat files
plots_dir <- file.path("/Users/naqvia/Desktop/AS-DMG/analyses/psi_clustering/plots/plots_survival_remDups")  # output directory for plot
...
metadata_sub <- metadata %>%
  ...
  dplyr::left_join(cluster_mem[,c("Kids_First_Biospecimen_ID","Cluster")], suffix = c("_DNA","_RNA")) %>%
