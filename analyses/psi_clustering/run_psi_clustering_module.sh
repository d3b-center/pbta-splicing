#!/bin/sh
#############################################################
# run_psi_clustering_module.sh: wrapper script to run the
# PSI clustering module
#
# arguments: updated histology file
#############################################################
...
perl create_matrix_of_PSI_removeDups.pl input/pbta-histologies.RNA-Seq.filtered.v2.tsv ~/Desktop/pan_cancer_rmats/filtered_samples_files.v2.txt ~/Desktop/AS-DMG/data/compiled_molecular_subtypes_with_clinical_pathology_feedback.tsv
...
Rscript stacked_barplots.R results/CC_groups.txt input/pbta-histologies.RNA-Seq.initial.tsv
