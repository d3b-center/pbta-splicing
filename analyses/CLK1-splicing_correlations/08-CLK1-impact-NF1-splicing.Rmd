...
rmats_clk1_file <- file.path(results_dir, "clk1-splice-events-rmats.tsv")
...
plot_CLK1_PSI_df <- rmats_goi %>% 
  ...
  left_join(stranded, by='Kids_First_Biospecimen_ID') %>%
...
# for HGG
items_of_interest_hgg <- c("Total CLK1", "CLK1-201", "CLK1-201 (Exon4) PSI", "Total NF1", "NF1-202", "NF1-215 PSI", "NF1-215",
         "NF1-202 (Exon23a) PSI", "NF1 pS864", "NF1 pS2796", "Total NF1 Protein")

# for other 
items_of_interest_other <- c("Total CLK1", "CLK1-201", "CLK1-201 (Exon4) PSI", "Total NF1", "NF1-202", "NF1-215 PSI", "NF1-215",
         "NF1-202 (Exon23a) PSI")
