################################################################################
# 08-model_and_plot-gsva.R
# written by Ammar Naqvi modified from OpenPBTA
#
# usage: Rscript 08-model_and_plot-gsva.R
################################################################################
...
# This script contains functions used to modeling 09-gsea-analysis.R scores
...
file_tiff_heatmap_plot = file.path(plots_dir,"heatmap_sign_gsva-kegg.tiff")
