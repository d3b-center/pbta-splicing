...
## filepaths 
optimal_cluster_tsv <- file.path(output_dir, "functional-sites", "optimal_clustering", "ccp_optimal_clusters.tsv")
cluster_membership_tsv <-  file.path(output_dir, "functional_cluster_members_by_cancer_group_subtype.tsv")
...
pdf(file.path(plots_dir, "functional_cluster_membership-subtypes.pdf"), height = 6, width = 11)
hist_subset %>% 
