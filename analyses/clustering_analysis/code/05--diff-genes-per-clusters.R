...
source(file.path(analysis_dir, 'util', 'diff_genes_per_cluster.R'))
...
# identify differentially expressed genes per cluster + pre-ranked gsea on those genes
diff_genes_per_cluster(input_mat =  input_mat,
