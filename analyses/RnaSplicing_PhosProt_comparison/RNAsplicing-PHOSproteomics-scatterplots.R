...
plotfile<-file_name<-paste("RnaPsiPhosAbundance_RnaTPMgt20", select_gene, "scatter.pdf", sep="_")
...
plotfile<-file_name<-paste("RnaTPMAbundancePhosAbundance_RnaTPMgt20", select_gene, "scatter.pdf", sep="_")
