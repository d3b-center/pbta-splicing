...
#
# usage: Rscript 03a-splicing_index_RI.R
################################################################################
...
# read in SI file
splice_index_file <- file.path(results_dir, "splicing_index.RI.total.txt")
