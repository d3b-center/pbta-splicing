...
#
# usage: Rscript 03a-splicing_index_A5SS.R
################################################################################
...
file_si_plot = "SBI-plot_A5SS.tiff"
...
# read in SI file
splice_index_file <- file.path(results_dir, "splicing_index.A5SS.total.txt")
