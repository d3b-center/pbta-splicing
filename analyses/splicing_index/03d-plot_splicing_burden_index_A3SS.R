...
#
# usage: Rscript 03a-splicing_index_A3SS.R
################################################################################
...
file_si_plot = "SBI-plot_A3SS.tiff"
...
# read in SI file
splice_index_file <- file.path(results_dir, "splicing_index.A3SS.total.txt")
