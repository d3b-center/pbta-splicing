...
kinase_activity <- readxl::read_excel(file.path(input_dir, "supplementarytable_kinase.xlsx"), sheet =3, skip=2) %>%
...
kinase_activity_hgat <-kinase_activity %>% 
...
### save heatmap
```{r}
pheatmap::pheatmap(as.matrix(kinase_activity_hgat),
...
kinase_activity_plot_all <-kinase_activity %>% 
  # order the columns for plotting
...
### save heatmap
```{r}
pheatmap::pheatmap(as.matrix(kinase_activity_plot_all),
...
# filter to pan cancer samples
kinase_activity_plot_sub <-kinase_activity %>% 
  # order the columns for plotting
...
### save heatmap
```{r}
pheatmap::pheatmap(as.matrix(kinase_activity_plot_sub),
...
# filter to pan cancer samples
kinase_activity_plot_hist <-kinase_activity %>% 
  # order the columns for plotting
...
### save heatmap
```{r}
pheatmap::pheatmap(as.matrix(kinase_activity_plot_hist),
